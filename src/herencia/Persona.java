...
public class Persona {  ////usamos protected porque sabemos que lo van utilizar otras clases
    ...
    public String obtenerDetalle(){
        return "Nombre: %s Edad: %d ". formatted(this.nombre, this.edad); //polimorfismo
    }
    ...
    @Override
    public int hashCode() {///realiza una operación y devuelve un número distinto
        int hash = 3;
